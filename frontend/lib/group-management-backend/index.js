...
import { idlFactory } from './group-management-backend.did.js';
export { idlFactory } from './group-management-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GROUP_MANAGEMENT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./group-management-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the group-management-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./group-management-backend.did.js")._SERVICE>}
 */
export const group_management_backend = createActor(canisterId);
